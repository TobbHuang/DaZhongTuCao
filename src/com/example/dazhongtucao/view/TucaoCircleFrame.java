...
public class TucaoCircleFrame {
	...
	public LinearLayout CreateTucaoCircleFrame(JSONObject json,
		...
		ll_p1.setMargins(5 * times, 5 * times, 0, 0);
		...
		RelativeLayout.LayoutParams rl_p1 = new RelativeLayout.LayoutParams(
				LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
		rl_p1.setMargins(10 * times, 10 * times, 10 * times, 0);
		...
		tv21 = new TextView(context);
		tv21.setLayoutParams(ll_p5);
		tv21.setText(name);
		tv21.setTextColor(context.getResources().getColor(R.color.theme));
		tv21.setTextSize(TypedValue.COMPLEX_UNIT_SP, 15);
		ll2.addView(tv21);

		TextView tv22 = new TextView(context);
		tv22.setLayoutParams(ll_p5);
		tv22.setText("Õ¬≤€¡À");
		tv22.setTextSize(TypedValue.COMPLEX_UNIT_SP, 15);
		ll2.addView(tv22);
		...
		tv23 = new TextView(context);
		tv23.setLayoutParams(ll_p5);
		tv23.setText(shopname);
		tv23.setTextColor(context.getResources().getColor(R.color.orange));
		tv23.setTextSize(TypedValue.COMPLEX_UNIT_SP, 15);
		ll2.addView(tv23);

		/*
		 * TextView tv24 = new TextView(context); tv24.setLayoutParams(ll_p5);
		 * tv24.setText(":"); tv24.setTextSize(TypedValue.COMPLEX_UNIT_SP, 15);
		 * ll2.addView(tv24);
		 */
		 ...
		 * rl_p2.addRule(RelativeLayout.CENTER_VERTICAL); LinearLayout ll3 = new
		 * LinearLayout(context); ll3.setLayoutParams(rl_p2);
		 * ll3.setOrientation(LinearLayout.HORIZONTAL);
		 */

		/*
		 * LinearLayout.LayoutParams ll_p61 = new LinearLayout.LayoutParams( 15
		 * * times, 15 * times); ll_p61.gravity = Gravity.CENTER_VERTICAL;
		 * ll_p61.setMargins(0, 0, 10*times, 0);
		 * 
		 * ImageView iv3 = new ImageView(context); iv3.setLayoutParams(ll_p61);
		 * iv3.setImageResource(R.drawable.restaurant); ll3.addView(iv3);
		 */

		/*
		 * TextView tv3 = new TextView(context); ll_p5.setMargins(5, 0, 5, 0);
		 * tv3.setLayoutParams(ll_p5); tv3.setText(shopname);
		 * tv3.setTextSize(TypedValue.COMPLEX_UNIT_SP, 10); ll3.addView(tv3);
		 */
