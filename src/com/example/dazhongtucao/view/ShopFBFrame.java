...
public class ShopFBFrame {
	
	ImageView iv2;
	TextView tv7;
	
	public LinearLayout CreateShopFBFrame(JSONObject json,
			Context context) {
		...
		try {
			...
			RelativeLayout.LayoutParams rl_p3 = new RelativeLayout.LayoutParams(
					20 * times, 20 * times);
			rl_p3.setMargins(0, 0, 30*times, 0);
			...
			RelativeLayout.LayoutParams rl_p4 = new RelativeLayout.LayoutParams(
					18*times, LayoutParams.WRAP_CONTENT);
			rl_p4.setMargins(0, 0, 48*times, 0);
			...
			RelativeLayout.LayoutParams rl_p5 = new RelativeLayout.LayoutParams(
					20 * times, 20 * times);
			rl_p5.setMargins(0, 0, 70*times, 0);
