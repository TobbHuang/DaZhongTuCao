...
public class TucaoConnect {
	public String Tucao(int UserID,String Key,int ShopID,String TC,int Anger){
		...
		try {
			...
			String url = ConstantData.URL + "/Tucao?UserID=" + UserID + "&Key="
					+ Key + "&ShopID=" + ShopID + "&TC=" + TC + "&Anger="
					+ Anger;
