...
public class ReplyConnect {
	public JSONObject Reply(int TCID,String Re) {
		...
		try {
			...
			String url = ConstantData.URL + "/Re?UserID=" + ConstantData.UserID
					+ "&Key=" + ConstantData.Key + "&TCID=" + TCID + "&Re="
					+ Re;
