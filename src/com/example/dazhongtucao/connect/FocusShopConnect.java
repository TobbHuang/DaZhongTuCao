...
public class FocusShopConnect {
	public String FocusShop(int UserID,String Key,int ShopID) {
		String result = null;
		try {
			...
			String url = ConstantData.URL + "/FocusShop?UserID=" + UserID
					+ "&Key=" + Key + "&ShopID=" + ShopID;
