...
public class RegisterConnect {
	public JSONObject Register(String NickName, String Account, String Password) {
		...
		try {
			...
			String url = ConstantData.URL + "/Register?NickName="
					+ NickName + "&Account=" + Account + "&Password="
					+ Password;
			...
			json = new JSONObject();
			try {
				json.put("result", "error");// 登录失败UserID返回-1，连接失败返回-2
